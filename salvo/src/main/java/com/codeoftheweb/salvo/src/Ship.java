...
public class Ship {
    ...
    public void setShipType(String shipType) {this.shipType = ShipType.valueOf(shipType.toUpperCase());}
    ...
    public String getShipTypeAsString() {return this.shipType.name().toLowerCase();}
}